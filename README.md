...
Client side routing allows for more interaction and control of the DOM from the client. It's also faster retrieving information that the client needs as it doesn't have to look back to the server to retrieve the information.
